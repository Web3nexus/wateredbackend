...
Route::prefix('v1')->group(function () {
    ...
    // Rituals & Incantations (public list with premium gating per item)
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // Appointments (auth-only)
        Route::get('/appointments', [\App\Http\Controllers\Api\V1\AppointmentController::class, 'index']);
        Route::get('/bookings', [\App\Http\Controllers\Api\V1\AppointmentController::class, 'index']);
        Route::post('/appointments', [\App\Http\Controllers\Api\V1\AppointmentController::class, 'store']);
        Route::post('/bookings', [\App\Http\Controllers\Api\V1\AppointmentController::class, 'store']);
        ...
        // Calendar write
        Route::post('/calendar/celebrate', [\App\Http\Controllers\Api\V1\CalendarController::class, 'storeCelebration']);
